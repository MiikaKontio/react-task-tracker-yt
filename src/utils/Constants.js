...
//music
export const DB_MUSIC_RECORDS = '/music-records';
...
export const DB_MUSIC_EVENT_BANDS = '/music-event-bands';
...
//NAVIGATION
export const NAVIGATION_DEMO = '/Demo';
...
export const NAVIGATION_DISC_GOLF_TRACK = '/discgolf-track';
//gear
...
//movements
export const NAVIGATION_ADD_MOVEMENT = '/addmovement';
...
//music
export const NAVIGATION_MUSIC_RECORD = '/record';
...
export const TRANSLATION_PEOPLE = 'people';
